...
DROP TABLE IF EXISTS METROVALENCIA.BATCH_SERVICES_LOOKUP, METROVALENCIA.FGV_DATE_SERVICES, METROVALENCIA.FGV_LINES, METROVALENCIA.FGV_LINES_STATIONS, METROVALENCIA.FGV_NEXT_STATIONS, METROVALENCIA.FGV_SERVICES, METROVALENCIA.FGV_STATIONS, METROVALENCIA.FGV_TIMETABLES;
...
CREATE TABLE IF NOT EXISTS METROVALENCIA.FGV_STATIONS (
    ...
    CONSTRAINT FGV_STATIONS_UN_WEB_ID UNIQUE (WEB_ID)
);
...
CREATE TABLE IF NOT EXISTS METROVALENCIA.BATCH_SERVICES_LOOKUP (
    ...
    STATION_ID INTEGER,
    STATION_WEB_ID INTEGER,
    CONSULTED_DATE DATE,
    SERVICE_ID INTEGER,
    CONSTRAINT BATCH_SERVICES_LOOKUP_FK FOREIGN KEY (STATION_ID) REFERENCES METROVALENCIA.FGV_STATIONS(ESTACION_ID_FGV) ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT BATCH_SERVICES_LOOKUP_FK_SERVICE_ID FOREIGN KEY (SERVICE_ID) REFERENCES METROVALENCIA.FGV_SERVICES(ID) ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT BATCH_SERVICES_LOOKUP_FK_STATION_WEB_ID FOREIGN KEY (STATION_WEB_ID) REFERENCES METROVALENCIA.FGV_STATIONS(WEB_ID) ON DELETE RESTRICT ON UPDATE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS METROVALENCIA.FGV_TIMETABLES (
    ...
    CONSTRAINT FGV_TIMETABLES_FK_SERVICE_ID FOREIGN KEY (SERVICE_ID) REFERENCES METROVALENCIA.FGV_SERVICES(ID) ON DELETE RESTRICT ON UPDATE RESTRICT
);
