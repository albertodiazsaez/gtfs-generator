...
CREATE TABLE METROVALENCIA.FGV_LINES (
	ID INTEGER NOT NULL,
...
CREATE TABLE METROVALENCIA.FGV_SERVICES (
	ID INTEGER,
...
CREATE TABLE METROVALENCIA.FGV_STATIONS (
	ID INTEGER NOT NULL,
...
CREATE TABLE METROVALENCIA.FGV_DATE_SERVICES (
	ID INTEGER,
	SERVICIO_ID INTEGER,
	FECHA DATE,
	SEDE VARCHAR(100),
...
CREATE TABLE METROVALENCIA.FGV_LINES_STATIONS (
...
CREATE TABLE METROVALENCIA.FGV_NEXT_STATIONS (
	ID INTEGER,
	SERVICIO_ID INTEGER,
...
CREATE TABLE METROVALENCIA.FGV_TIMETABLES (
